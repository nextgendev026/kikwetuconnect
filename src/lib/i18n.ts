...
const resources = {
  en: {
    translation: {
      nav: { home: 'Home', baraza: 'Baraza', explore: 'Explore', spaces: 'Spaces', students: 'Students', experts: 'Experts', messages: 'Messages', sessions: 'Sessions', wallet: 'Wallet', market: 'Mtaa Exchange', nyumba: 'Nyumba Kumi', quizzes: 'Quizzes', profile: 'Profile', saved: 'Saved', settings: 'Settings', notifications: 'Notifications' },
      ...
      create: { post: 'Write a post', question: 'Ask a question', poll: 'Create a poll', media: 'Upload an image or video', audio: 'Record an audio note', session: 'Offer an expert session', listing: 'Create a marketplace listing', alert: 'Post a Nyumba Kumi alert' },
  ...
  sw: {
    translation: {
      nav: { home: 'Nyumbani', baraza: 'Baraza', explore: 'Gundua', spaces: 'Nafasi', students: 'Wanafunzi', experts: 'Wataalamu', messages: 'Ujumbe', sessions: 'Vipindi', wallet: 'Pochi', market: 'Soko la Mtaa', nyumba: 'Nyumba Kumi', quizzes: 'Maswali', profile: 'Wasifu', saved: 'Imehifadhiwa', settings: 'Mipangilio', notifications: 'Arifa' },
