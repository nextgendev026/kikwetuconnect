    ...
    <div className="pb-8 animate-fade-in-up">
      <section className="page-head" style={{ marginBottom: 16 }}>
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: 'var(--muted)' }}>Connect with verified experts — or apply to become one</p>
        </div>
        ...
        <>
          ...
          <div style={s.card} className="mb-5">
            <div className="flex items-center gap-3 mb-4">
              <div className="relative flex-1">
                ...
                <input placeholder="Search professionals..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)}
          ...
          {loading ? (
            ...
            <div style={s.card} className="text-center py-12">
              ...
              <p className="font-medium mb-1" style={{ color: 'var(--ink)' }}>No professionals yet</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: 'color-mix(in oklab, var(--night) 70%, transparent)' }} onClick={() => setShowApplyForm(false)}>
          <div style={{ ...s.card, width: 'min(500px, 100%)', maxHeight: '90vh', overflowY: 'auto' }} onClick={e => e.stopPropagation()}>
            ...
            <div className="space-y-3">
              ...
              <div><label className="text-[10px] font-semibold block mb-1" style={{ color: 'var(--muted)' }}>Professional Title</label><input value={appForm.title} onChange={e => setAppForm(p => ({ ...p, title: e.target.value }))} style={s.input} placeholder="e.g. Senior Agronomist, Software Engineer" /></div>
              ...
              <p className="text-[9px] text-center" style={{ color: 'var(--muted)' }}>Applications are reviewed by admins. Approved experts get a verified badge and appear in the directory.</p>
            </div>
          </div>
        </div>
      )}
