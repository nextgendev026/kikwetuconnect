-- Spaces are private member pages: their posts must NOT surface in the
-- main feed. The client-side feed already filters `space_id IS NULL`, but
-- get_personalized_feed (used by the "For You" tab) did not. Align it.
